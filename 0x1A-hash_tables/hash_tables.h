 ...
 * @key: The key, string
 * The key is unique in the Hashash_table
 ...
 * because we want our Hashash_table to use a Chaining collision handling
 */
...
int hash_table_set_func(hash_table_t *hash_t, const char *key, const char *value);
...
int shash_table_set_func(shash_table_t *hash_t, const char *key, const char *value);
